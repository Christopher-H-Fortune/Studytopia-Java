package com.fullsail.christopherfortune.studytopia.Activities.LeaderboardFiles.FlaschcardTestLeaderboard;
...
public class FlashcardTestLeaderboardActivity extends AppCompatActivity implements FlashcardTestLeaderboardFragment.FlashcardTestLeaderboardInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flashcard_test_leaderboard);

        Intent startingIntent = getIntent();

        if(startingIntent.hasExtra("testId") && startingIntent.hasExtra("subject")){

            testIdChosen = startingIntent.getStringExtra("testId");
            subjectChosen = startingIntent.getStringExtra("subject");
        }
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    case R.id.nav_study_group_map:
                        ...
                        if(networkInfo != null){
                            ...
                            if(networkInfo.isConnected()){
                                ...
                                Intent mapIntent = new Intent(FlashcardTestLeaderboardActivity.this, StudyGroupMapActivity.class);
                                startActivity(mapIntent);
                            }

                        } else {

                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(FlashcardTestLeaderboardActivity.this);
                    ...
                    case R.id.nav_study_group:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent studyGroupIntent = new Intent(FlashcardTestLeaderboardActivity.this, StudyGroupActivity.class);
                        startActivity(studyGroupIntent);
                        break;
                    case R.id.nav_topic_of_the_day:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent topicOfDayIntent = new Intent(FlashcardTestLeaderboardActivity.this, TopicOfTheDayActivity.class);
                        startActivity(topicOfDayIntent);
                        break;
                    case R.id.nav_forums:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent forumsSubjectListIntent = new Intent(FlashcardTestLeaderboardActivity.this, ForumsSubjectListActivity.class);
                        startActivity(forumsSubjectListIntent);
                        break;
                    case R.id.nav_public_flashcards:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent publicFlashcardsIntent = new Intent(FlashcardTestLeaderboardActivity.this, PublicFlashcardsActivity.class);
                        startActivity(publicFlashcardsIntent);
                        break;
                    case R.id.nav_flashcards:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent flashcardsListIntent = new Intent(FlashcardTestLeaderboardActivity.this, FlashcardTestSubjectListActivity.class);
                        startActivity(flashcardsListIntent);
                        break;
                    case R.id.nav_logout:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent logoutIntent = new Intent(FlashcardTestLeaderboardActivity.this, LoginSignupActivity.class);
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.flashcard_test_leaderboard_frame, FlashcardTestLeaderboardFragment.newInstance(), FlashcardTestLeaderboardFragment.TAG).commit();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.done_menu_button:
                ...
                Intent flashcardTestSubjectListIntent = new Intent(this, PublicFlashcardsActivity.class);
                startActivity(flashcardTestSubjectListIntent);
                return true;
        }
    ...
    public void passLeaderboardListView(ListView leaderboardListView) {
        ...
        String studyGroupId = "";
        if(!subjectChosen.isEmpty() && !testIdChosen.isEmpty()){

            DatabaseReference leaderboardDatabaseReference = mFirebaseDatabase.getReference();

            leaderboardDatabaseReference.child("publicTests").child("subjects").child(subjectChosen).child(testIdChosen).child("leaderboard").addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        } else if (!studyGroupId.isEmpty() && !testIdChosen.isEmpty()){

            DatabaseReference leaderboardDatabaseReference = mFirebaseDatabase.getReference();

            leaderboardDatabaseReference.child("studyGroups").child("studyGroupsToDisplay").child(studyGroupId).child("studyGroupTests").child(testIdChosen).child("leaderboard").addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
