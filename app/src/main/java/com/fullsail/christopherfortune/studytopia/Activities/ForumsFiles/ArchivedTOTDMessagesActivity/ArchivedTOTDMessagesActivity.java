package com.fullsail.christopherfortune.studytopia.Activities.ForumsFiles.ArchivedTOTDMessagesActivity;
...
public class ArchivedTOTDMessagesActivity extends AppCompatActivity implements TopicOfTheDayForumFragment.TopicOfTheDayForumInterface {
    ...
    private static TopicOfTheDay archivedTopic;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_archived_totd_messages);

        Intent startingIntent = getIntent();
        if(startingIntent.hasExtra("archivedTopic")){
            archivedTopic = (TopicOfTheDay)startingIntent.getSerializableExtra("archivedTopic");
        }
        ...
        DatabaseReference archivedTopicOfDayMessages = mFirebaseDatabase.getReference();
        archivedTopicOfDayMessages.child("TopicOfTheDay").child("archivedTopics").child(Integer.toString(archivedTopic.getTopicNumber())).child("messages").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        archivedTopicOfDayMessages.keepSynced(true);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    case R.id.nav_study_group_map:
                        ...
                        if(networkInfo != null){
                            ...
                            if(networkInfo.isConnected()){
                                ...
                                Intent mapIntent = new Intent(ArchivedTOTDMessagesActivity.this, StudyGroupMapActivity.class);
                                startActivity(mapIntent);
                            }

                        } else {

                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ArchivedTOTDMessagesActivity.this);
                    ...
                    case R.id.nav_study_group:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent studyGroupIntent = new Intent(ArchivedTOTDMessagesActivity.this, StudyGroupActivity.class);
                        startActivity(studyGroupIntent);
                        break;
                    case R.id.nav_topic_of_the_day:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent topicOfDayIntent = new Intent(ArchivedTOTDMessagesActivity.this, TopicOfTheDayActivity.class);
                        startActivity(topicOfDayIntent);
                        break;
                    case R.id.nav_forums:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent forumsSubjectListIntent = new Intent(ArchivedTOTDMessagesActivity.this, ForumsSubjectListActivity.class);
                        startActivity(forumsSubjectListIntent);
                        break;
                    case R.id.nav_public_flashcards:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent publicFlashcardsIntent = new Intent(ArchivedTOTDMessagesActivity.this, PublicFlashcardsActivity.class);
                        startActivity(publicFlashcardsIntent);
                        break;
                    case R.id.nav_flashcards:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent flashcardsListIntent = new Intent(ArchivedTOTDMessagesActivity.this, FlashcardTestSubjectListActivity.class);
                        startActivity(flashcardsListIntent);
                        break;
                    case R.id.nav_logout:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Intent logoutIntent = new Intent(ArchivedTOTDMessagesActivity.this, LoginSignupActivity.class);
        ...
        if (actionbar != null) {
            ...
            actionbar.setTitle(Html.fromHtml("<font color='#ffffff'>Archived Topic of the Day Forum</font>", Html.FROM_HTML_MODE_LEGACY));
        }

        getSupportFragmentManager().beginTransaction().replace(R.id.archived_totd_messages_frame, TopicOfTheDayForumFragment.newInstance(), TopicOfTheDayForumFragment.TAG).commit();
    }
            ...
            if (userProfileData != null) {
                ...
                userProfileImageSmrtImage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent profileIntent = new Intent(ArchivedTOTDMessagesActivity.this, UserProfileActivity.class);
                        ...
                        sendMessageButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if(messageEditText.getText().toString().trim().isEmpty()){
                                    ...
                                    editMessageReference.child("TopicOfTheDay").child("archivedTopics").child(Integer.toString(archivedTopic.getTopicNumber())).child("messages").child(user.getUid() + " " + forumMessageArrayList.get(messageSelected).getDateSent() + " " + forumMessageArrayList.get(messageSelected).getTimeSent()).child("messageEntered").setValue(messageEditText.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            messageEditText.setText(null);
                                            sendMessageButton.setImageResource(R.drawable.ic_arrow_forward_black_24dp);
                                            Toast.makeText(ArchivedTOTDMessagesActivity.this, "Edit Saved", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            }
                        ...
                        alertDialogBuilder.setPositiveButton(
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        deleteMessageReference.child("TopicOfTheDay").child("archivedTopics").child(Integer.toString(archivedTopic.getTopicNumber())).child("messages").child(user.getUid() + " " + forumMessageArrayList.get(messageSelected).getDateSent() + " " + forumMessageArrayList.get(messageSelected).getTimeSent()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
                                            public void onSuccess(Void aVoid) {
                                                Toast.makeText(ArchivedTOTDMessagesActivity.this, "Message Deleted", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    }
                                });
    ...
    public void sendMessage() {
        ...
        if(messageEntered.isEmpty()){
            ...
            messageReference.child("TopicOfTheDay").child("archivedTopics").child(Integer.toString(archivedTopic.getTopicNumber())).child("messages").child(user.getUid() + " " + dateTimeString).setValue(forumMessage).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void aVoid) {
                    messageEditText.setText(null);
                }
